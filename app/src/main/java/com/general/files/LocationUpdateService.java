...
public class LocationUpdateService extends Service implements UpdateDriverLocation.OnDemoLocationListener {
    ...
    public class PickupRequestReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
            // Get the pickup request data from the intent
            String date = intent.getStringExtra("date");
            String location = intent.getStringExtra("location");

            // Display a notification to the user
            NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "pickup_request_channel")
                    .setSmallIcon(R.drawable.ic_notification)
                    .setContentTitle("Pickup Request")
                    .setContentText("You have received a pickup request for " + date + " at " + location)
