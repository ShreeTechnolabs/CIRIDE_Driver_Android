package ciride.driver.deliverAll;
...
import ciride.driver.BaseActivity;
import ciride.driver.BuildConfig;
import ciride.driver.CallScreenActivity;
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.backImgView) {
                ...
                if (isDeliver) {
                   ...
                   if (!isDeliver && isPhotoUploaded.equalsIgnoreCase("No") && PickedFromRes.equalsIgnoreCase("Yes")) {
                        takeAndUploadPic(getActContext());
                    } else {
//                        showBillDialog();
